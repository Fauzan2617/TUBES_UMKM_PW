...
<body>
    ...
    <main>
        <section class="menu" id="foods">
            <h2>Makanan</h2>
            <div class="card">
                <img src="food1.jpg" alt="Makanan 1">
                <h3>Nasi Goreng</h3>
                <p>Lezat, pedas dan gurih.</p>
            </div>
            <div class="card">
                <img src="food2.jpg" alt="Makanan 2">
                <h3>Sate Ayam</h3>
                <p>Daging ayam panggang dengan bumbu kacang.</p>
            </div>
            <!-- Tambahkan makanan lain di sini -->
        </section>
        <section class="menu" id="drinks">
            <h2>Minuman</h2>
            <div class="card">
                <img src="drink1.jpg" alt="Minuman 1">
                <h3>Es Teh</h3>
                <p>Menyegarkan dengan es batu yang melumer.</p>
            </div>
            <div class="card">
                <img src="drink2.jpg" alt="Minuman 2">
                <h3>Jus Jeruk</h3>
                <p>Segar dengan vitamin C.</p>
            </div>
            <!-- Tambahkan minuman lain di sini -->
        </section>
    </main>
    <div
    x-data
