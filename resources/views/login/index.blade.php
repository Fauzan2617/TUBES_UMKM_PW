    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @if (session()->has('success'))
                <div x-data="{ showAlert: true }" x-show="showAlert" id="alert-3"
            ...
            @if (session()->has('loginError'))
                <div x-data="{ showAlert: true }" x-show="showAlert" id="alert-2"
                    class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                    role="alert">
                    {{ session('loginError') }}
                    <button type="button" @click="showAlert = false"
                        class="ms-auto -mx-1.5
                        -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200
                        inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400
